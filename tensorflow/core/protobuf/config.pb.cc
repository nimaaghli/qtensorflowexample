...
void InitDefaultsTensorConnection() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTensorConnectionImpl);
}
...
void InitDefaultsCallableOptionsImpl() {
  ...
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsTensorConnection();
  {
...
void InitDefaultsCallableOptions() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsCallableOptionsImpl);
}
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 112, -1, sizeof(::tensorflow::TensorConnection)},
  { 119, -1, sizeof(::tensorflow::CallableOptions)},
};
...
::google::protobuf::uint8* CallableOptions::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_run_options()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, *run_options_, deterministic, target);
  }
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::TensorConnection* Arena::CreateMessage< ::tensorflow::TensorConnection >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::TensorConnection >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::CallableOptions* Arena::CreateMessage< ::tensorflow::CallableOptions >(Arena* arena) {
