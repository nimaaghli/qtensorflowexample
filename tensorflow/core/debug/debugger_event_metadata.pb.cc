...
void InitDefaultsDebuggerEventMetadataImpl() {
...
void InitDefaultsDebuggerEventMetadata() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsDebuggerEventMetadataImpl);
}
...
DebuggerEventMetadata::DebuggerEventMetadata()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fdebug_2fdebugger_5fevent_5fmetadata_2eproto::InitDefaultsDebuggerEventMetadata();
  }
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::third_party::tensorflow::core::debug::DebuggerEventMetadata* Arena::Create< ::third_party::tensorflow::core::debug::DebuggerEventMetadata >(Arena* arena) {
